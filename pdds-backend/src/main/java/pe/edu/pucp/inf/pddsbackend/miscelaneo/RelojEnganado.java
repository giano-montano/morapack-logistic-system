...
public class RelojEnganado extends Clock
{
    ...
    // puntos de referencia para el cálculo: sim = simBase + (nowReal - realBase) *
    // factor
    ...
    // For batch tests: advance simulated clock manually (useful for integration
    // with DES)
    ...
    /**
     * Convierte un instante simulado en el instante real correspondiente atendiendo
     * a realBase, simBase y speedFactor.
     */
    ...
    /**
     * Milisegundos desde Instant.now() hasta el instante real que corresponde a
     * simInstant. Puede ser negativo si estamos "retrasados".
     */
     ...
     * Notas:
     *
     * Usamos floor en el cálculo realDeltaMillis para no adelantar el reloj real
     * por redondeos; puedes usar Math.round si prefieres.
     *
     * millisUntilRealTime devuelve Long.MAX_VALUE si está pausado — el motor
     * comprobará isPaused() y actuará en consecuencia.
     */
