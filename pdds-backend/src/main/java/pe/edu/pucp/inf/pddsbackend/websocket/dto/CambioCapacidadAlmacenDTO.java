...
/**
 * DTO para notificar cambios en la capacidad de un almacén via WebSocket
 * Se envía cuando:
 * - Sale un vuelo (reduce capacidad - solo si NO es infinito)
 * - Llega un vuelo (aumenta capacidad - solo si NO es infinito)
 * - Cliente retira productos (reduce capacidad - solo si NO es infinito)
 * 
 * ⚠️ NO se envía para almacenes infinitos ya que su capacidad no cambia realmente
 */
