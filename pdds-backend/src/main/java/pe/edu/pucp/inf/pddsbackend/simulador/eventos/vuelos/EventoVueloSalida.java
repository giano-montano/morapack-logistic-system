...
public class EventoVueloSalida implements EventoSimulacion
{
    ...
    public void procesar(ContextoSimulacion ctx) throws Exception
    {
        ...
        {
            ctx.log("❌ EventoVueloSalida: Almacén origen no encontrado id="
        ...
        if (capacidadTotalACargar > 0)
        {
            ctx.log(String.format(
                    ...
                    almacenOrigen.isEsInfinito() ? "Infinito" : "Intermedio",
            ...
            try
            {
                ...
                String nombreDestino = almacenDestino != null
                        && almacenDestino.getNombreCiudad() != null
                                ...
                                : "Almacén " + vuelo.getIdAlmacenDestino();
        ...
        {
            // System.out.println("⏭️ Vuelo ID=" + idVuelo + " sin productos - NO se envía
            // por WebSocket");
        }

        if (capacidadTotalACargar > 0)
        { // importante para que no colapse de forma estúpida
            ...
            System.out.println("      - Capacidad disponible: "
                    + (almacenOrigen.getCapacidadMaxima() - almacenOrigen.getCapacidadOcupada()));
            System.out.println("      - UUIDs prods que tiene dentro ahora: "
            ...
            // Liberar espacio en almacén origen; PERO OJO, CASO DE ALMACÉN INFINITO!! SE
            // TELETRANSPORTA NOMÁS
            ...
            // CeARGARÁN EN EL VUELO
            // ADEMÁS, SI ES EL ULTIMO VUELO DE UNA PROGRAMACION, EL PRODUCTO DEBE MARCARSE
            // COMO PRONTO A ENTREGAR
