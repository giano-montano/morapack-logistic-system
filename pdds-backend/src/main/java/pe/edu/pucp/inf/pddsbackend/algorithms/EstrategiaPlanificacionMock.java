...
/**
 * Estrategia de planificación MOCK para testing de simulación.
 * Genera soluciones dummy que siempre son válidas, sin ejecutar el algoritmo GRASP real.
 * 
...
public class EstrategiaPlanificacionMock extends EstrategiaPlanificacion {
    ...
    private static final double PROBABILIDAD_PROGRAMAR_PEDIDO = 0.7; // 70% chance de programar un pedido
    ...
    public SalidaProblemaPlanificacion planificar(EntradaProblemaPlanificacion entrada) {
        ...
        try {
            ...
            List<Almacen> almacenesInfinitos = estadoGlobal.devolverAlmacenesInfinitosOConStockDisponible();
    ...
    private Programacion generarProgramacionMock(
        ...
        try {
            ...
            Almacen almacenOrigen = almacenesInfinitos.get(random.nextInt(almacenesInfinitos.size()));
