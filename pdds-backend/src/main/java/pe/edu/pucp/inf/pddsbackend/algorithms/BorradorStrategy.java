...
//                                                         List<PedidoParaAlgoritmo> pedidos) {
//        // Pesos (ajustables)
...
//            for (VueloParaAlgoritmo v : r.getVuelosOrdenados()) {
//                if (v == null) continue;
...
//            if (almacenes != null) {
//                Optional<AlmacenParaAlgoritmo> aOpt = almacenes.stream()
...
//    }
//
//    private List<PedidoParaAlgoritmo> removerPedidosSatisfechosOIrrelevantes(
//            List<PedidoParaAlgoritmo> pedidosLocal,
//            PedidoParaAlgoritmo ultimoPedidoAsignado,
//            RutaADestino ruta,
//            List<AlmacenParaAlgoritmo> almacenes,
//            List<VueloParaAlgoritmo> vuelos) {
//
...
//        for (PedidoParaAlgoritmo p : pedidosLocal) {
//            if (p == null) continue;
//
//            int total = p.getCantidadProductosPedidos() == null ? 0 : p.getCantidadProductosPedidos();
//            int entregados = p.getCantidadProductosEntregados() == null ? 0 : p.getCantidadProductosEntregados();
